...
readonly PYTHON_VERSION=$(python3 -c "import sys; print(f'{sys.version_info.major}.{sys.version_info.minor}')")
...
configure () {
    local CMAKEFLAGS="
        ...
        -D PYTHON3_PACKAGES_PATH=$HOME/.local/lib/python${PYTHON_VERSION}/site-packages
...
fix () {
    echo "Fix version '$1' of OpenCV"
    echo 'export LD_LIBRARY_PATH=/usr/local/lib/:$LD_LIBRARY_PATH' >> ~/.bashrc
    # echo 'export PYTHONPATH=/usr/local/lib/python$PYTHON_VERSION/site-packages:$PYTHONPATH' >> ~/.bashrc
    
    source ~/.bashrc
    
    mkdir -p ~/.local/lib/python${PYTHON_VERSION}/site-packages/opencv_python-"$1".dist-info
    touch ~/.local/lib/python${PYTHON_VERSION}/site-packages/opencv_python-"$1".dist-info/METADATA
    
    mkdir -p ~/.local/lib/python${PYTHON_VERSION}/site-packages/opencv_contrib_python-"$1".dist-info
    touch ~/.local/lib/python${PYTHON_VERSION}/site-packages/opencv_contrib_python-"$1".dist-info/METADATA
...
verify () {
    ...
    python3 -c "import cv2; print('OpenCV Version: ', cv2.__version__); print('OpenCV File: ', cv2.__file__)"
